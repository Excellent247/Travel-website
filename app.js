...
function navToggle(e){
  ...
  gsap.to(".line1", 0.5, {rotate: "45", y: 7, background: "black"});
  gsap.to(".line2", 0.5, {opacity: "0"});
  gsap.to("#logo", 1, {color: "black"});
  gsap.to(".cursor", 1, {opacity: "0"});
  gsap.to(".line3", 0.5, {rotate: "-45", width: "2rem", y: -7.5, background: "black"});
  ...
  gsap.to(".cursor", 1, {opacity: "1"});
  gsap.to(".line3", 0.5, {rotate: "0", width: "1rem", y: 0, background: "white"});
